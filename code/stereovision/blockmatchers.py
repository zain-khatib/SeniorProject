...
class StereoBM(BlockMatcher):
    ...
    parameter_maxima = {"search_range": None,
                       "window_size": 255,
                       "stereo_bm_preset": cv2.STEREO_BM_PREFILTER_NORMALIZED_RESPONSE}# old cv2.STEREO_BM_NARROW_PRESET
    ...
    def _replace_bm(self):
        ...
        self._blocl_matcher = cv2.StereoBM_create(numDisparities=16,blockSize=15)

    def __init__(self, stereo_bm_preset,
                 search_range=80,
                 window_size=21,
                 settings=None):
